...
import { CastShareButton } from './CastShareButton'
  ...
  return (
    <div className="flex flex-col min-h-[500px] px-4 py-6">
      ...
      <div className="text-center mb-6">
        <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-br from-danz-pink-500 to-danz-purple-600 shadow-neon-pink mb-4">
      ...
      {/* Rewards breakdown */}
      <div className="bg-danz-dark-800/50 rounded-2xl p-4 mb-6 border border-danz-dark-700">
        <h2 className="text-sm text-gray-400 mb-3">Today&apos;s Rewards</h2>
        <div className="space-y-2">
          <div className="flex justify-between items-center">
            <span className="text-gray-300">Base XP</span>
            <span className="text-danz-cyan-400 font-mono">+{rewards.baseXp}</span>
          </div>
          {rewards.streakBonus > 0 && (
            <div className="flex justify-between items-center">
              <span className="text-gray-300">Streak Bonus</span>
              <span className="text-danz-pink-400 font-mono">+{rewards.streakBonus}</span>
            </div>
          )}
          {hasReflection && rewards.reflectionBonus > 0 && (
            <div className="flex justify-between items-center">
              <span className="text-gray-300">Reflection Bonus</span>
              <span className="text-danz-purple-400 font-mono">+{rewards.reflectionBonus}</span>
            </div>
          )}
          <div className="border-t border-danz-dark-600 pt-2 mt-2">
            <div className="flex justify-between items-center">
              <span className="text-white font-semibold">Total XP</span>
              <span className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-danz-pink-400 to-danz-cyan-400">
                +{rewards.totalXp}
              </span>
            </div>
            <div className="flex justify-between items-center mt-1">
              <span className="text-gray-500 text-sm">DANZ Tokens</span>
              <span className="text-danz-cyan-400 font-mono text-sm">
          ...
          {MOCK_LEADERBOARD.map(entry => (
            <div
              ...
              className={`
                ...
                ${entry.rank <= 3
                  ? 'bg-gradient-to-r from-danz-pink-500/10 to-danz-purple-500/10 border border-danz-pink-500/20'
                  : 'bg-danz-dark-800/50 border border-danz-dark-700'
                }
              `}
            >
              <div className={`
                ...
                ${entry.rank === 1 ? 'bg-yellow-500/20 text-yellow-400' :
                  ...
                  'bg-danz-dark-700 text-gray-500'
                }
              `}>
                {entry.rank}
              </div>
              <div className="w-8 h-8 rounded-full bg-danz-dark-700 flex items-center justify-center">
                {entry.avatar}
              </div>
              <div className="flex-1">
              ...
              <div className="text-right">
                <div className="text-danz-pink-400 font-mono text-sm">
                  🔥 {entry.streak}
                </div>
              </div>
            </div>
      ...
      <div className="mt-6 pt-4 border-t border-white/5 text-center">
        <p className="text-xs text-gray-500">
          ...
          <a
            ...
            className="text-danz-pink-400 hover:text-danz-pink-300 transition-colors"
          >
            FlowBond Tech
          </a>
        </p>
