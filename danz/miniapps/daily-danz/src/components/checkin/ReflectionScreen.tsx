  ...
  return (
    <div className="flex flex-col min-h-[500px] px-4 py-6">
      ...
      <div className="text-center mb-6">
        ...
        <div className="mt-2 text-xs text-danz-cyan-400">
      ...
      {/* Feeling selection */}
      <div className="mb-6">
        <h2 className="text-sm text-gray-400 mb-3">How did it feel?</h2>
            ...
            <button
              ...
              className={`
                ...
                ${selectedFeeling === option.id
                  ? 'bg-gradient-to-r from-danz-pink-500 to-danz-purple-500 text-white shadow-neon-pink'
                  : 'bg-danz-dark-800 text-gray-300 hover:bg-danz-dark-700 border border-danz-dark-600'
                }
              `}
            >
      ...
      <div className="mb-8 flex-1">
        <h2 className="text-sm text-gray-400 mb-3">What did it bring you?</h2>
            ...
            <button
              ...
              className={`
                ...
                ${selectedBenefits.includes(option.id)
                  ? 'bg-gradient-to-r from-danz-pink-500/30 to-danz-purple-500/30 text-white border-2 border-danz-pink-500'
                  : 'bg-danz-dark-800 text-gray-300 hover:bg-danz-dark-700 border border-danz-dark-600'
                }
              `}
            >
      ...
      <div className="space-y-3">
        <button
          ...
          className={`
            ...
            transition-all duration-200
            ${hasSelection
              ? 'bg-gradient-to-r from-danz-pink-500 to-danz-purple-500 text-white shadow-neon-pink hover:shadow-neon-glow'
              : 'bg-danz-dark-700 text-gray-400'
            }
          `}
        >
