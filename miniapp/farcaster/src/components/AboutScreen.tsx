...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "Set a reminder on any event and FlowB will notify you before it starts via Telegram DM or Farcaster push notification.",
  },
  {
    q: "Where can I use FlowB?",
    a: "FlowB is available on the web at flowb.me, as a Telegram mini app, right here in Farcaster, and soon as a native mobile app.",
  },
];
